...
class CashAdvanceCreateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'cash_advance_user', 'date', 'cash_amount', 'term', 'description', 'status']
...
class HalfDayCreateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = HalfDayForm
        fields = ['id', 'half_day_user', 'date', 'time_out', 'description', 'status']
...
class LeaveCreateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = LeaveForm
        fields = ['id', 'leave_user', 'start_date', 'end_date', 'description', 'status', 'leave_type']
...
class OverTimeCreateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = OverTimeForm
        fields = ['id', 'overtime_user', 'date', 'overtime_hours', 'description', 'status']
...
class TemporaryShiftCreateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'tempshift_user', 'start_date', 'end_date', 'start_time', 'end_time', 'description', 'status']
