...
class TimeIn(models.Model):
    date = models.ForeignKey(Attendance, on_delete=models.CASCADE, related_name='time_in')
    time_in = models.TimeField()
    
class TimeOut(models.Model):
    date = models.ForeignKey(Attendance, on_delete=models.CASCADE, related_name='time_out')
