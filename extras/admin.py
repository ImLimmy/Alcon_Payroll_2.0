...
class RatingsAdmin(admin.ModelAdmin):
  list_display = ('year',
                    ...
                    'night_shifts',
                    'night_shift_and_overtime', 
                    'night_shift_and_rest_days',
                    'night_shift_and_special_nonworking_days',
                    'night_shift_special_nonworking_and_rest_days',
                    'night_shift_double_special_nonworking_days_and_rest_days',
                    ...
                    'regular_holiday_rest_day_and_overtime_days',
                    'double_holidays_and_overtime_days',
                    'double_holidays_rest_day_and_overtime_days',
                    'rest_day_night_shift_and_overtime_days',
                    'special_nonworking_day_night_shift_and_overtime_days',
                    ...
                    'regular_holiday_night_shift_and_overtime_days',
