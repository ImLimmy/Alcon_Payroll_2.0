...
class CareersDetail(UserPermissionMixin, generics.RetrieveUpdateDestroyAPIView):
    ...
    def get(self, request, *args, **kwargs):
        # Retrieve the instance using the default get_object method
        instance = self.get_object()
        # Retrieve the queryset using the primary key of the instance
        queryset = self.queryset.get(pk=instance.pk)
