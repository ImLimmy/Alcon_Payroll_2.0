...
class Ratings(models.Model):
    ...
    def regular_holiday_and_rest_days(self):
        regular_holiday_and_rest_day = self.regular_rate * self.holiday_rate * self.rest_day
        return round(regular_holiday_and_rest_day , 3)
    
    @property
    def double_holidays(self):
        double_holiday = self.regular_rate * self.holiday_rate * (self.holiday_rate / 2)
        return round(double_holiday , 3)
    
    @property
    def double_holidays_and_rest_days(self):
        double_holiday_and_rest_day = self.regular_rate * self.holiday_rate + (self.holiday_rate / 2) + ((self.rest_day - 1) * 3)
    ...
    def special_nonworking_day_and_overtime_days(self):
        special_nonworking_day_and_overtime_day = self.special_nonworking_days * (self.overtime_rate + 0.05)
        return round(special_nonworking_day_and_overtime_day , 3)
    
    @property
    def special_nonworking_rest_day_and_overtime_days(self):
        special_nonworking_rest_day_and_overtime_day = self.special_nonworking_and_rest_days * (self.overtime_rate + 0.05)
        return round(special_nonworking_rest_day_and_overtime_day , 3)
    
    @property
    def double_special_nonworking_rest_day_and_overtime_days(self):
        double_special_nonworking_rest_day_and_overtime_day = self.double_special_nonworking_days * (self.overtime_rate + 0.05)
        return round(double_special_nonworking_rest_day_and_overtime_day , 3)
    
    @property
    def regular_holiday_and_overtime_days(self):
        regular_holiday_and_overtime_day = self.regular_holidays * (self.overtime_rate + 0.05)
        return round(regular_holiday_and_overtime_day , 3) 
    
    @property
    def rest_day_night_shift_and_overtime_days(self):
        rest_day_night_shift_and_overtime_day = self.rest_day * self.night_rate * (self.overtime_rate + 0.05)
    ...
    def special_nonworking_day_rest_day_night_shift_and_overtime_days(self):
        special_nonworking_day_rest_day_night_shift_and_overtime_day = self.special_nonworking_and_rest_days  * self.night_rate * (self.overtime_rate + 0.05)
    ...
    def double_special_nonworking_rest_days_night_shift_and_overtime_days(self):
        double_special_nonworking_rest_days_night_shift_and_overtime_day = self.double_special_nonworking_and_rest_days * self.night_rate * (self.overtime_rate + 0.05)
    ...
    def regular_holiday_rest_day_night_shift_and_overtime_days(self):
        regular_holiday_rest_day_night_shift_and_overtime_day = self.night_shift_regular_holiday_and_rest_days * (self.overtime_rate + 0.05)
    ...
    def night_shift_and_double_holidays_and_overtime_days(self):
        night_shift_and_double_holidays_and_overtime_day = self.night_shift_and_double_holidays * (self.overtime_rate + 0.05)
    ...
    def night_shift_double_holidays_rest_days_and_overtime_days(self):
        night_shift_double_holidays_rest_days_and_overtime_day = self.night_shift_double_holidays_and_rest_days * (self.overtime_rate + 0.05)
