...
urlpatterns = [
    ...
    path('pagibig/<int:pk>/update/', views.PagIbigDetail.as_view(), name='pagibig_update'),
    ...
    path('philhealth/<int:pk>/update/', views.PhilHealthDetail.as_view(), name='philhealth_update'),
